...
import { MotionLabUniversePrelude } from "./motion-lab-scene";

type ProgressRef = MutableRefObject<number>;
type CanvasRef = MutableRefObject<HTMLCanvasElement | null>;

type HeroRelaySceneProps = {
  progress: ProgressRef;
  sceneProgress: ProgressRef;
  sourceCanvas: CanvasRef;
  reducedMotion: boolean;
};

export function RelayTexture({
  progress,
  sourceCanvas,
  reducedMotion,
}: Pick<HeroRelaySceneProps, "progress" | "sourceCanvas" | "reducedMotion">) {
...
export function HeroRelayScene({
  progress,
  sceneProgress,
  sourceCanvas,
  reducedMotion,
  ...
  return (
    <>
      ...
      <MotionLabUniversePrelude
        progress={sceneProgress}
        reducedMotion={reducedMotion}
        driveCamera={!reducedMotion}
      />
      <RelayTexture
        progress={progress}
